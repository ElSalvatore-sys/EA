...
const Home: React.FC = () => {
  ...
  const clientLogos = [
    ...
    { 
      ...
      logo: 'https://klavierschule-glennmiller.de/wp-content/uploads/2024/12/cropped-Klavierschule-Glenn-Miller-Logo-32x32.png'
    }
  ];
            ...
            {industries.map((industry, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-8">
                    <div className={`w-16 h-16 bg-gradient-to-br ${industry.gradient} rounded-3xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-500`}>
